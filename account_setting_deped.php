...
<?php
  ...
  include_once('account_setting_deped_get.php');
...
<body>
                    ...
                    <div id="change-username-table-wrap">
                      <table>
                        <tr>
                          ...
                          <td>
                            <input type="text" name="chnge_username" id="chnge_username" class="input" value=<?php echo $deped_username;?> readonly="readonly">
                          </td>
                          <td>
                            &nbsp;
                          </td>
                      ...
                      <div class="change-button-wrap">
                        <input type="submit" id="change_usrname_button" value="Change" class="button"> 
                      </div>  
                    ...
                    <div id="change-username-table-wrap">
                      <table>
                        <tr>
                          ...
                          <td>
                            <input type="password" name="user-current-password" id="current_pass" class="input">
                          </td>
                          <td>
                            &nbsp;
                          </td>
  ...
  <script type="text/javascript" src="js/account_setting_deped.js"></script>      
