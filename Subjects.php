...
<body>
  ...
  <header>
        ...
        <div id="class-wrap">
              ...
              <div id="class-list-wrap"> 
                ...
                <div id="view-form-wrap">
                  ...
                  <input type="button" name="add_anncemnt" rel="#addsubjects-window" class="button modal" value="Add Subjects">
    ...
    <footer>
      ...
      <div class="boxes">     
      <div id="addsubjects-window" class="window">
          ...
          <div id="addstudent-wrap">
            <form action="add_subject.php" method="post">
             <div id="students-info-wrap"> 
              <table>
                <th colspan="4"><h2>Fill-in the required information</h2></th>
                <tr>
                  <td>
                    <label>Name:</label>
                  </td>
                  <td>
                    <input type="text" name="subject_name[1]" class="input" placeholder=" Subject Name">
                  </td>
                  <td>
                    <label>Units</label>
                  </td>
                  <td>
                    <input type="text" name="subject_units[1]" class="input" placeholder="No. of Units">
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <input type="button" id="" name="add_subject" class="button add-bstudent" value="+">
                  </td>  
                </tr>              
              </table>
            </div>  
